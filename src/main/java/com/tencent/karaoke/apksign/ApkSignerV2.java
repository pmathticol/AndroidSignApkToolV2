...
package com.tencent.karaoke.apksign;
...
public abstract class ApkSignerV2 {
    ...
    public static byte[] generateApkSignatureSchemeV2Block(
            List<SignerConfig> signerConfigs,
            Map<Integer, byte[]> contentDigests) throws InvalidKeyException, SignatureException {
        // FORMAT:
    ...
    public static byte[] generateSignerBlock(
    ...
    public static Pair<String, ? extends AlgorithmParameterSpec>
